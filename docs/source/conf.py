...
project = u'FlyBehaviors'
copyright = u'2010, CDS'
...
htmlhelp_basename = 'fly_behaviors_doc'
...
latex_documents = [
  ('index', 'fly_behaviors.tex', u'FlyBehaviors Documentation',
   u'CDS', 'manual'),
]
...
man_pages = [
    ('index', 'fly_behaviors', u'FlyBehaviors Documentation',
     [u'CDS'], 1)
]
